...
func (ctrl *Controller) RegisterRoutes(v1 *gin.RouterGroup) {
	...
	group.POST("/databases/:kb_id/documents/:doc_id/parse", ctrl.RetryParse)
	group.POST("/databases/:kb_id/documents/:doc_id/index", ctrl.IndexOne)
	group.POST("/databases/:kb_id/documents/index", ctrl.IndexMany)
	group.POST("/databases/:kb_id/documents/index-pending", ctrl.IndexPending)
