...
import { ChevronLeft, ChevronRight, CircleHelp } from 'lucide-vue-next'
...
const selectedPreviewPath = computed(() => selectedEntry.value?.path || '')
...
const handleListBreadcrumbClick = async ({ item }) => {
