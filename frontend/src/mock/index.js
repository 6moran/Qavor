...
export const mockAgents = [
  {
    ...
    avatar: '/assets/defaults/agent.png',
    model: 'gpt-4',
    is_builtin: true,
    is_subagent: false,
    capabilities: ['files', 'file_upload'],
    configurable_items: {
...
export const mockThreads = [
  {
    ...
    updated_at: '2024-07-27T10:30:00Z',
    is_pinned: true,
    message_count: 12
  },
  {
    ...
    updated_at: '2024-07-26T16:45:00Z',
    is_pinned: false,
    message_count: 8
  }
]
...
export const mockInfo = {
  success: true,
  data: { name: 'Qavor AI', version: '1.0.0', description: '智能 AI 助手平台' }
}
...
export const mockDocuments = [
  ...
  },
  {
    ...
    updated_at: '2024-07-27T08:00:00Z'
  },
  {
    id: 'doc-006',
    name: '产品需求文档.pdf',
...
export const mockDashboardConversations = [
  ...
  },
  {
    ...
    message_count: 5,
    status: 'active',
    created_at: '2024-07-27T08:30:00Z'
  },
  {
    id: 'thread-004',
    uid: 'user-001',
...
export const mockDashboardFeedbacks = [
  ...
  },
  {
    ...
    agent_name: '数据分析助手',
    comment: '结果不够准确',
    created_at: '2024-07-27T09:45:00Z'
  },
  {
    id: 'fb-003',
    rating: 'like',
    ...
    agent_name: '代码助手',
    comment: '解决了性能问题',
    created_at: '2024-07-26T16:30:00Z'
  }
]
...
export const mockGraphSubgraph = {
  nodes: [
    { id: 'node-1', label: '概念A', type: 'concept' },
    { id: 'node-2', label: '概念B', type: 'concept' }
  ],
...
export const mockGraphStats = {
  node_count: 156,
  edge_count: 234,
  label_counts: { concept: 89, entity: 67 }
}
        ...
        children: [
          {
            name: '技术文档',
            type: 'folder',
            path: '/user-data/documents/技术文档',
            is_dir: true,
            children: [
              {
                name: 'API文档.md',
                type: 'file',
                path: '/user-data/documents/技术文档/API文档.md',
                size: 12560,
                modified_at: '2024-07-25T14:30:00Z'
              },
              {
                name: '系统架构设计.md',
                type: 'file',
                path: '/user-data/documents/技术文档/系统架构设计.md',
                size: 28900,
                modified_at: '2024-07-27T08:00:00Z'
              },
              {
                name: '开发规范.md',
                type: 'file',
                path: '/user-data/documents/技术文档/开发规范.md',
                size: 5600,
                modified_at: '2024-07-25T11:00:00Z'
              }
            ]
          },
          {
            name: '产品文档',
            type: 'folder',
            path: '/user-data/documents/产品文档',
            is_dir: true,
            children: [
              {
                name: '用户手册.pdf',
                type: 'file',
                path: '/user-data/documents/产品文档/用户手册.pdf',
                size: 2450000,
                modified_at: '2024-07-21T10:00:00Z'
              },
              {
                name: '技术白皮书.docx',
                type: 'file',
                path: '/user-data/documents/产品文档/技术白皮书.docx',
                size: 1890000,
                modified_at: '2024-07-26T11:00:00Z'
              },
              {
                name: '产品需求文档.pdf',
                type: 'file',
                path: '/user-data/documents/产品文档/产品需求文档.pdf',
                size: 3200000,
                modified_at: '2024-07-27T10:00:00Z'
              }
            ]
          },
          {
            name: '数据分析',
            type: 'folder',
            path: '/user-data/documents/数据分析',
            is_dir: true,
            children: [
              {
                name: '数据分析报告.xlsx',
                type: 'file',
                path: '/user-data/documents/数据分析/数据分析报告.xlsx',
                size: 856000,
                modified_at: '2024-07-23T16:00:00Z'
              },
              {
                name: '测试用例文档.docx',
                type: 'file',
                path: '/user-data/documents/数据分析/测试用例文档.docx',
                size: 980000,
                modified_at: '2024-07-26T16:30:00Z'
              }
            ]
          },
          {
            name: 'readme.md',
            type: 'file',
            path: '/user-data/documents/readme.md',
            size: 1024,
            modified_at: '2024-07-20T09:00:00Z'
          }
        ]
      },
      {
        name: 'config',
        type: 'folder',
        path: '/user-data/config',
        is_dir: true,
        children: [
          {
            name: 'config.json',
            type: 'file',
            path: '/user-data/config/config.json',
            size: 2560,
            modified_at: '2024-07-26T10:00:00Z'
          },
          {
            name: 'settings.yaml',
            type: 'file',
            path: '/user-data/config/settings.yaml',
            size: 1536,
            modified_at: '2024-07-25T15:00:00Z'
          }
        ]
      },
      {
        name: 'scripts',
        type: 'folder',
        path: '/user-data/scripts',
        is_dir: true,
        children: [
          {
            name: 'import_data.py',
            type: 'file',
            path: '/user-data/scripts/import_data.py',
            size: 4096,
            modified_at: '2024-07-24T14:00:00Z'
          },
          {
            name: 'backup.sh',
            type: 'file',
            path: '/user-data/scripts/backup.sh',
            size: 1024,
            modified_at: '2024-07-22T11:00:00Z'
          }
        ]
      },
      {
        ...
        children: [
          {
            name: 'app.log',
            type: 'file',
            path: '/user-data/logs/app.log',
            size: 1048576,
            modified_at: '2024-07-27T12:00:00Z'
          },
          {
            name: 'error.log',
            type: 'file',
            path: '/user-data/logs/error.log',
            size: 524288,
            modified_at: '2024-07-27T11:30:00Z'
          }
        ]
      }
    ]
